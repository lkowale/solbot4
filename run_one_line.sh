#!/bin/bash
# Run Nav2 simulation with OneLine Navigator
...
PARAMS_FILE=$(ros2 pkg prefix solbot4_nav2_bringup)/share/solbot4_nav2_bringup/params/nav2_params_one_line.yaml

echo "=========================================="
echo "  OneLine Navigator"
echo "=========================================="
echo ""
